...
export const TopBar: React.FC = () => {
  const { ageRangeStart, ageRangeEnd, exportData, config } = useSimulationStore();
  ...
  const userName = config.userName || "山田 太郎";

  return (
    <header className="fixed top-0 left-60 right-0 h-16 bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 z-40 transition-colors">
